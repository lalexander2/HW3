...
if name == "Raenita":
    ...
    if age >= 50:
        ...
        print("Your life has not yet begun. You are going to invent something that will change the world for many people.")
else:
    print("Your fortune is dark. You will lose all that you are carrying when you next leave your house.")